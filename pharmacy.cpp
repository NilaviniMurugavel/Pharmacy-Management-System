...
void customer::display()
{
    ...
    while(!f.eof())
    {
        cout<<setw(12)<<c1.idno<<setw(15)<<c1.name<<setw(20)<<c1.dob<<setw(20)<<c1.mob_no<<endl;
        f.read((char *)&c1,sizeof(c1));
    }
    f.close();
}
...
public :
    void get_stock()
    {
        ...
        cout<<"Enter quantity : ";
        cin>>quantity;
        cout<<"Enter manufacture data : ";
        cin>>md>>mm>>my;
        cout<<"Enter expiry data : ";
        cin>>ed>>em>>ey;
        cout<<"Enter price : ";
        cin>>price;
    }
    void put_stock()
    {
        cout<<setw(10)<<stock_id<<setw(20)<<stock_name<<setw(10)<<quantity<<setw(10)<<md<<" "<<mm<<" "<<my<<setw(10)<<ed<<em<<ey<<setw(10)<<price<<endl;
    }
    int getid()
    {
        return stock_id;
        ...
        case 1:
                ...
                case 2:
                        do
                        {
                             ...
                             cout<<"            \xdb 1. SIGN IN\n"<<endl;
                             cout<<"            \xdb 2. SIGN UP\n"<<endl;
                            // cout<<"            \xdb 3. DELETE ACCOUNT"<<endl;
                                       ...
                                       if(check2)
                                       {
                                           do
                                           {
                                                ...
                                                case 1:
                                                   ...
                                                   // cout<<" You have to pay : "<<o.get_amount()<<endl;
                                                    getch();
                                                    break;
                                                case 2 :
                                                    o.cancel_order(id);
